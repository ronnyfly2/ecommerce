...
const tableEmpty = computed(() => !tableLoading.value && (sizes.value?.length ?? 0) === 0)
const tableColumns = [
  { key: 'name', label: 'Nombre' },
  { key: 'abbreviation', label: 'Prefijo' },
...
<template>
  <div class="space-y-4">
    ...
    <UiCard :padding="false">
      <UiTable :data="sizes" :loading="tableLoading" :empty="tableEmpty" :columns="tableColumns" loading-color="primary" loading-text="Cargando tallas..." empty-message="No hay tallas">
        <template #empty-icon>
